 ...
 * 
 */
public class ShopShopFileParserException extends Exception {

    public ShopShopFileParserException(Throwable cause) {
        super(cause);
    }

    private static final long serialVersionUID = -4664141625944031936L;
