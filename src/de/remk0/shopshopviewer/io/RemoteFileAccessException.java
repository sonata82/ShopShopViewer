 ...
 * 
 */
public class RemoteFileAccessException extends Exception {

    public RemoteFileAccessException(Throwable cause) {
        super(cause);
    }

    private static final long serialVersionUID = 1567716988675559387L;
